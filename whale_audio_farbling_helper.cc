...
WhaleAudioFarblingHelper::WhaleAudioFarblingHelper(double fudge_factor,
                                                   uint64_t seed,
                                                   bool max)
    : fudge_factor_(fudge_factor), seed_(seed), max_(max) {}

WhaleAudioFarblingHelper::~WhaleAudioFarblingHelper() = default;

void WhaleAudioFarblingHelper::FarbleAudioChannel(float* dst,
                                                  size_t count) const {
  if (max_) {
    uint64_t v = seed_;
...
void WhaleAudioFarblingHelper::FarbleFloatTimeDomainData(
...
void WhaleAudioFarblingHelper::FarbleByteTimeDomainData(
    const float* input_buffer,
...
void WhaleAudioFarblingHelper::FarbleConvertToByteData(
    const float* source,
    unsigned char* destination,
    size_t len,
    double min_decibels,
...
void WhaleAudioFarblingHelper::FarbleConvertFloatToDb(const float* source,
                                                      float* destination,
                                                      size_t len) const {
  if (max_) {
    uint64_t v = seed_;
